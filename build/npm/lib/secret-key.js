...
secretBox = function ({ KMS }) {
  var decrypt, encrypt, keyLength, kmsDecrypt, kmsEncrypt, nonceLength, randomKey;
  ({
  ...
  encrypt = (() => {
    var _ref = _asyncToGenerator(function* (message, encoding = "utf8") {
      ...
      ciphertext = Buffer.from(_tweetnacl2.default.secretbox(message, nonce, key));
      // Lock the key
