...
publicKeyTest = function (SDK) {
  return _asyncToGenerator(function* () {
    ...
    var A, B, PublicKey, cipher, message, output, privateKey, publicKey;
    ({ PublicKey } = (0, _index2.default)(SDK));
    // Test Key Pair Generation
    ({ privateKey, publicKey } = yield PublicKey.generateKeyPair());
    (0, _powerAssert2.default)(_rec._expr(_rec._capt(privateKey, "arguments/0"), {
      ...
      filepath: "tests/public-key.coffee",
      line: 10,
      async: true
    ...
    B = yield PublicKey.generateKeyPair();
    message = "Hello World!";
    // Person A encrypts the message for person B.
    cipher = yield PublicKey.encrypt(B.publicKey, A.privateKey, message);
